            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        <img   style={{ marginRight: '20px' }}  src="https://cdn.pixabay.com/photo/2020/08/05/13/12/eco-5465432_1280.png" alt="" />
                ...
                <div style={styleObjUl}>
                    <div style={{marginLeft: '250px'}}>  <a href="#" onClick={(e) => handlePlantsClick(e)} style={styleA}>Plants</a></div>
